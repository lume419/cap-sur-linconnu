...
function buildTripPdf(doc, trip){
  ...
  legs.forEach(function(leg, idx){
    ...
    if(leg.ferryInfo){
      ...
      // Ferry piéton uniquement : le véhicule reste au port (voir passengerOnly dans lib/trip-engine.js).
      if(f.passengerOnly === true) ferryTxt += " Ce ferry n'embarque pas de véhicules.";
