...
function trimGlyphCaches(maxGlyphs){
  ...
  fonts.forEach(function(f){
    [f.font, f.boldFont].forEach(function(font){
      ...
      // Le cache de mise en forme (voir memoiseLayout) suit le même ménage : une entrée y pèse quelques dizaines
      // d'octets, mais il grossirait sans fin sur un serveur qui exporte dans toutes les langues.
      if(font && font.__layoutMemo && font.__layoutMemo.size > LAYOUT_CACHE_MAX / 2) font.__layoutMemo.clear();
    });
  });
  return trimmed;
}
