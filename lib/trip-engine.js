...
const { COUNTRIES, TRANSPORT, FERRY_ROUTES, SEA_CROSSINGS, TOLL_RATE_BY_COUNTRY, TOLL_MIN_DISTANCE_KM,
  ...
  SICILY_PROVINCES, HR_POSTCODE_TO_ISLAND, CV_CONCELHO_TO_ISLAND, GR_ISLAND_PATTERNS,
...
var ADJACENT_PAIRS = new Set([
  ...
  // ── Afrique de l'Ouest ────────────────────────────────────────────────────────────────────
  // Le bloc ouest-africain ne rejoint le reste du réseau QUE par un seul point : Guerguerat, le
  // poste-frontière entre la Mauritanie et le Sahara occidental, à ~70 km de Nouadhibou — seule
  // route terrestre entre le Maghreb et l'Afrique de l'Ouest, et renforcée par l'ouverture d'un
  // nouveau poste annoncée conjointement par le Maroc et la Mauritanie.
  'MR|EH',
  // Mauritanie-Sénégal : le pont de Rosso n'est PAS ouvert (50 % des travaux en mai 2026,
  // inauguration visée mars 2027), mais la route passe par le barrage de Diama, qui porte une
  // vraie chaussée routière, ou par le bac de Rosso.
  'MR|SN',
  'ML|SN', 'ML|GN', 'ML|CI', 'ML|BF',
  'SN|GN', 'SN|GW', 'SN|GM',
  'GN|CI', 'GN|LR', 'GN|SL', 'GN|GW',
  'SL|LR', 'LR|CI',
  'BF|CI', 'BF|GH', 'BF|TG',
  'CI|GH', 'GH|TG'
  // NE FIGURENT PAS ICI, volontairement :
  // - **Mali-Mauritanie** : le Mali a FERMÉ cette frontière de 2 337 km en octobre 2025 pour motif
  //   sécuritaire, coupant l'un des principaux axes logistiques du Sahel occidental vers l'Atlantique.
  // - **Mauritanie-Algérie** et **Mali-Algérie** : frontières sahariennes dont l'ouverture effective
  //   au trafic civil n'a pas pu être établie ; non ajoutées faute de source, plutôt que supposées.
  // - **Cap-Vert** : archipel sans aucune liaison, même maritime, vers le continent — voir
  //   COUNTRIES.CV. Il reste donc entièrement séparé du réseau routier africain, ce qui est exact.
]);
