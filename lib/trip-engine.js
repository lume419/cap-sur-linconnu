...
const { COUNTRIES, TRANSPORT, FERRY_ROUTES, SEA_CROSSINGS, TOLL_RATE_BY_COUNTRY, TOLL_MIN_DISTANCE_KM,
  ...
  GR_POROS_MAINLAND_NAMES, VAN_RULES, MOTO_RULES } = TripData;
...
function legAllowed(from, to, ignoreMaxLeg, skipEv){
  ...
  if(toLandmass !== from.landmass && ferryRouteFor(from.landmass, toLandmass)) return true;
  if(from.zone && seaCrossingFor(from.zone, to.zone !== undefined ? to.zone : zoneOf(to))) return true;
