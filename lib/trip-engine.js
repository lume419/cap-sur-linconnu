...
var LEG_CONSTRAINTS = { maxLegKm: 0, electric: false, ferryEnabled: true, roadKmh: 0 };
...
function generateTrip(params){
  ...
  try {
    ...
    AVOID_TENSION = true;
    LEG_CONSTRAINTS = { maxLegKm: 0, electric: false, ferryEnabled: true, roadKmh: 0 };
  ...
  LEG_CONSTRAINTS = { maxLegKm: maxLegKm, electric: !!TRANSPORT[transportKey].electric, ferryEnabled: ferryEnabled,
    roadKmh: TRANSPORT[transportKey].speed };
