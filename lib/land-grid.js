...
// Mer d'Åland (8e audit, 18/09/2026) : entre Turku et la côte suédoise, l'archipel d'Åland et celui de Turku découpent
// le trait en portions d'eau de 24 km au plus, juste sous WATER_CHECK_KM (25) : « Turku → Näsviken (Suède), 260 km par
// la route » passait, alors que la route réelle fait le tour du golfe de Botnie par Tornio (~1 200 km). Ligne en trois
// segments tracée dans la mer d'Åland, vérifiée point par point comme entièrement sur l'eau dans la grille : à 19,30° E
// au nord (entre Grisslehamn et Eckerö), puis décalée à 19,65° E au sud pour contourner l'archipel extérieur de
// Stockholm. Elle coupe Turku ↔ Suède, Stockholm ↔ Helsinki, Stockholm ↔ Turku, et épargne Stockholm ↔ Uppsala,
// Norrtälje ↔ Grisslehamn, Turku ↔ Helsinki. La Suède et la Finlande restent reliées par la route, par Tornio.
const BARRIERS = [
  { name: 'Kvarken', a: [64.00, 20.97], b: [63.30, 20.97] },
  { name: "Mer d'Åland (nord)", a: [60.70, 19.30], b: [59.95, 19.30] },
  { name: "Mer d'Åland (jonction)", a: [59.95, 19.30], b: [59.90, 19.65] },
  { name: "Mer d'Åland (sud)", a: [59.90, 19.65], b: [59.20, 19.65] }
];
const BARRIER_KM = 3;
