...
(function(){
  ...
  var STRINGS = {
    fr: {
      ...
      'footer.text': "Cap sur l'inconnu — générateur ludique, aucune donnée n'est envoyée où que ce soit. Communes : IGN / geo.api.gouv.fr (Etalab) pour la France, GeoNames (licence CC-BY) pour l'Andorre, l'Espagne, le Portugal, la Belgique, les Pays-Bas, le Luxembourg, la Suisse, l'Allemagne, l'Italie, l'Autriche, Saint-Marin, le Liechtenstein, Monaco, Malte, Guernesey, Jersey, la République tchèque, la Pologne et la Slovaquie. Points d'intérêt et fond de carte : © les contributeurs d'OpenStreetMap (licence ODbL). Péages : VINCI Autoroutes (France), Autopistas (Espagne), Via Verde/Ascendi (Portugal), Autostrade per l'Italia (Italie) — autoroutes gratuites en Belgique, en Andorre, aux Pays-Bas, au Luxembourg, en Allemagne, à Saint-Marin, au Liechtenstein, à Monaco, à Malte et en Pologne (hors trois sections concédées) ; vignette annuelle en Suisse, en Autriche, en République tchèque et en Slovaquie (pas de péage au trajet) — ni péage ni vignette à Guernesey et Jersey.",
    ...
    en: {
      ...
      'footer.text': "Cap on the unknown — a playful generator, no data is ever sent anywhere. Towns: IGN / geo.api.gouv.fr (Etalab) for France, GeoNames (CC-BY licence) for Andorra, Spain, Portugal, Belgium, the Netherlands, Luxembourg, Switzerland, Germany, Italy, Austria, San Marino, Liechtenstein, Monaco, Malta, Guernsey, Jersey, the Czech Republic, Poland and Slovakia. Points of interest and map background: © OpenStreetMap contributors (ODbL licence). Tolls: VINCI Autoroutes (France), Autopistas (Spain), Via Verde/Ascendi (Portugal), Autostrade per l'Italia (Italy) — free motorways in Belgium, Andorra, the Netherlands, Luxembourg, Germany, San Marino, Liechtenstein, Monaco, Malta and Poland (except three concession sections); an annual vignette in Switzerland, Austria, the Czech Republic and Slovakia (no per-trip toll) — no toll or vignette in Guernsey or Jersey.",
    ...
    es: {
      ...
      'footer.text': "Rumbo a lo desconocido — un generador lúdico, no se envía ningún dato a ningún sitio. Municipios: IGN / geo.api.gouv.fr (Etalab) para Francia, GeoNames (licencia CC-BY) para Andorra, España, Portugal, Bélgica, los Países Bajos, Luxemburgo, Suiza, Alemania, Italia, Austria, San Marino, Liechtenstein, Mónaco, Malta, Guernsey, Jersey, República Checa, Polonia y Eslovaquia. Puntos de interés y fondo de mapa: © colaboradores de OpenStreetMap (licencia ODbL). Peajes: VINCI Autoroutes (Francia), Autopistas (España), Via Verde/Ascendi (Portugal), Autostrade per l'Italia (Italia) — autopistas gratuitas en Bélgica, Andorra, los Países Bajos, Luxemburgo, Alemania, San Marino, Liechtenstein, Mónaco, Malta y Polonia (salvo tres tramos concesionados); viñeta anual en Suiza, Austria, República Checa y Eslovaquia (sin peaje por trayecto) — sin peaje ni viñeta en Guernsey y Jersey.",
    ...
    pt: {
      ...
      'footer.text': "Rumo ao desconhecido — um gerador lúdico, nenhum dado é enviado para lado nenhum. Municípios: IGN / geo.api.gouv.fr (Etalab) para França, GeoNames (licença CC-BY) para Andorra, Espanha, Portugal, Bélgica, os Países Baixos, o Luxemburgo, a Suíça, a Alemanha, a Itália, a Áustria, São Marinho, o Liechtenstein, o Mónaco, Malta, Guernsey, Jersey, a República Checa, a Polónia e a Eslováquia. Pontos de interesse e fundo de mapa: © colaboradores do OpenStreetMap (licença ODbL). Portagens: VINCI Autoroutes (França), Autopistas (Espanha), Via Verde/Ascendi (Portugal), Autostrade per l'Italia (Itália) — autoestradas gratuitas na Bélgica, em Andorra, nos Países Baixos, no Luxemburgo, na Alemanha, em São Marinho, no Liechtenstein, no Mónaco, em Malta e na Polónia (exceto três troços concessionados); vinheta anual na Suíça, na Áustria, na República Checa e na Eslováquia (sem portagem por trajeto) — sem portagem nem vinheta em Guernsey e Jersey.",
      'footer.legalMentions': 'Aviso legal',
    ...
    nl: {
      ...
      'footer.text': "Koers naar het onbekende — een speelse generator, er wordt nooit gegevens ergens naartoe verstuurd. Gemeenten: IGN / geo.api.gouv.fr (Etalab) voor Frankrijk, GeoNames (CC-BY-licentie) voor Andorra, Spanje, Portugal, België, Nederland, Luxemburg, Zwitserland, Duitsland, Italië, Oostenrijk, San Marino, Liechtenstein, Monaco, Malta, Guernsey, Jersey, Tsjechië, Polen en Slowakije. Bezienswaardigheden en kaartachtergrond: © OpenStreetMap-bijdragers (ODbL-licentie). Tol: VINCI Autoroutes (Frankrijk), Autopistas (Spanje), Via Verde/Ascendi (Portugal), Autostrade per l'Italia (Italië) — gratis snelwegen in België, Andorra, Nederland, Luxemburg, Duitsland, San Marino, Liechtenstein, Monaco, Malta en Polen (behalve drie concessietrajecten); jaarlijkse vignet in Zwitserland, Oostenrijk, Tsjechië en Slowakije (geen tol per rit) — geen tol of vignet op Guernsey en Jersey.",
    ...
    de: {
      ...
      'footer.text': "Kurs auf das Unbekannte — ein spielerischer Generator, es werden nie Daten irgendwohin gesendet. Gemeinden: IGN / geo.api.gouv.fr (Etalab) für Frankreich, GeoNames (CC-BY-Lizenz) für Andorra, Spanien, Portugal, Belgien, die Niederlande, Luxemburg, die Schweiz, Deutschland, Italien, Österreich, San Marino, Liechtenstein, Monaco, Malta, Guernsey, Jersey, Tschechien, Polen und die Slowakei. Sehenswürdigkeiten und Kartenhintergrund: © OpenStreetMap-Mitwirkende (ODbL-Lizenz). Maut: VINCI Autoroutes (Frankreich), Autopistas (Spanien), Via Verde/Ascendi (Portugal), Autostrade per l'Italia (Italien) — mautfreie Autobahnen in Belgien, Andorra, den Niederlanden, Luxemburg, Deutschland, San Marino, Liechtenstein, Monaco, Malta und Polen (außer drei Konzessionsabschnitten); jährliche Vignette in der Schweiz, in Österreich, in Tschechien und in der Slowakei (keine Maut pro Fahrt) — keine Maut oder Vignette auf Guernsey und Jersey.",
    ...
    lb: {
      ...
      'footer.text': "Kurs op d'Onbekannt — e spilleresche Generator, et gi ni Donnéeën iergendwouhinner geschéckt. Gemengen: IGN / geo.api.gouv.fr (Etalab) fir Frankräich, GeoNames (CC-BY-Lizenz) fir Andorra, Spuenien, Portugal, d'Belsch, d'Nidderlanden, Lëtzebuerg, d'Schwäiz, Däitschland, Italien, Éisträich, San Marino, Liechtenstein, Monaco, Malta, Guernsey, Jersey, Tschechien, Polen a d'Slowakei. Sehenswiirdegkeeten a Kaart-Hannergrond: © d'OpenStreetMap-Mataarbechter (ODbL-Lizenz). Peage: VINCI Autoroutes (Frankräich), Autopistas (Spuenien), Via Verde/Ascendi (Portugal), Autostrade per l'Italia (Italien) — gratis Autobunnen an der Belsch, an Andorra, an den Nidderlanden, zu Lëtzebuerg, an Däitschland, zu San Marino, zu Liechtenstein, zu Monaco, zu Malta a zu Polen (ausser dräi Konzessiounsabschnëtter); eng jäerlech Vignette an der Schwäiz, an Éisträich, an Tschechien an an der Slowakei (kee Peage pro Streck) — weder Peage nach Vignette op Guernsey a Jersey.",
    ...
    it: {
      ...
      'footer.text': "Rotta verso l'ignoto — un generatore ludico, nessun dato viene mai inviato da nessuna parte. Comuni: IGN / geo.api.gouv.fr (Etalab) per la Francia, GeoNames (licenza CC-BY) per Andorra, Spagna, Portogallo, Belgio, Paesi Bassi, Lussemburgo, Svizzera, Germania, Italia, Austria, San Marino, Liechtenstein, Monaco, Malta, Guernsey, Jersey, Repubblica Ceca, Polonia e Slovacchia. Punti d'interesse e sfondo mappa: © i contributori di OpenStreetMap (licenza ODbL). Pedaggi: VINCI Autoroutes (Francia), Autopistas (Spagna), Via Verde/Ascendi (Portogallo), Autostrade per l'Italia (Italia) — autostrade gratuite in Belgio, Andorra, Paesi Bassi, Lussemburgo, Germania, San Marino, Liechtenstein, Monaco, Malta e Polonia (tranne tre tratti in concessione); vignetta annuale in Svizzera, Austria, Repubblica Ceca e Slovacchia (nessun pedaggio per tragitto) — nessun pedaggio né vignetta a Guernsey e Jersey.",
    ...
    nds: {
      ...
      'footer.text': 'Kurs op dat Unbekannte — en spöölschen Generator, dat warrt nienich Daten sennt. Gemeenden: IGN / geo.api.gouv.fr (Etalab) för Frankriek, GeoNames (CC-BY-Lizenz) för Andorra, Spanien, Portugal, Belgien, de Nedderlannen, Luxemburg, de Swiez, Düütschland, Italien, Oostriek, San Marino, Liechtenstein, Monaco, Malta, Guernsey, Jersey, Tschechien, Polen un de Slowakei. Sehenswöördigkeiten un Kaartgrund: © de OpenStreetMap-Mitmakers (ODbL-Lizenz). Toll: VINCI Autoroutes (Frankriek), Autopistas (Spanien), Via Verde/Ascendi (Portugal), Autostrade per l’Italia (Italien) — tollfrie Autobahnen in Belgien, Andorra, de Nedderlannen, Luxemburg, Düütschland, San Marino, Liechtenstein, Monaco, Malta un Polen (buten dree Konzessschoonsafsnitten); jährliche Vignette in de Swiez, in Oostriek, in Tschechien un in de Slowakei (keen Toll per Reis) — keen Toll un keen Vignette op Guernsey un Jersey.',
    ...
    frr: {
      ...
      'footer.text': 'Kurs tu det unbekannte — en spöölsk generator, nian dooten wårde ai fuurtstüürd. Gemiine: IGN / geo.api.gouv.fr (Etalab) foor Frankrik, GeoNames (CC-BY-lizens) foor Andorra, Spaanien, Portugal, Belgien, Nedderlönje, Luxemburg, dai Swiits, Düütsklönj, Italien, Österiek, San Marino, Liechtenstein, Monaco, Malta, Guernsey, Jersey, Tschechien, Polen an di Slowakei. Sååchtjensweerdiheeden an kaart-uunergrünj: © dai OpenStreetMap-mäduurbeeders (ODbL-lizens). Tol: VINCI Autoroutes (Frankrik), Autopistas (Spaanien), Via Verde/Ascendi (Portugal), Autostrade per l’Italia (Italien) — tolfrii autobahne önj Belgien, Andorra, Nedderlönje, Luxemburg, Düütsklönj, San Marino, Liechtenstein, Monaco, Malta an Polen (bihaale trii konzessionsstriaken); iaarli vignet önj dai Swiits, önj Österiek, önj Tschechien an önj di Slowakei (nian tol per reise) — nian tol jam nian vignet önj Guernsey an Jersey.',
    ...
    fur: {
      ...
      'footer.text': 'Rote viers l\'ignot — un gjeneradôr ludic, nissun dât al ven mai mandât in nissun puest. Comuns: IGN / geo.api.gouv.fr (Etalab) pe Francie, GeoNames (licence CC-BY) par Andore, Spagne, Portugal, Belgjiche, Paîs Bas, Lussemburc, Svuizare, Gjermanie, Italie, Austrie, San Marin, Liechtenstein, Monaco, Malta, Guernsey, Jersey, la Republiche Ceche, la Polonie e la Slovachie. Ponts di interès e fondâl di mape: © i contribuents di OpenStreetMap (licence ODbL). Pedaçs: VINCI Autoroutes (Francie), Autopistas (Spagne), Via Verde/Ascendi (Portugal), Autostrade per l\'Italia (Italie) — autostradis gratuitis in Belgjiche, Andore, tai Paîs Bas, in Lussemburc, in Gjermanie, in San Marin, in Liechtenstein, in Monaco, in Malta e in Polonie (infûr di trê tratis in concession); vignete anuâl in Svuizare, in Austrie, in Republiche Ceche e in Slovachie (nissun pedaç par viaç) — nissun pedaç ni vignete a Guernsey e Jersey.',
    ...
    lld: {
      ...
      'footer.text': 'Rota vers l\'ignot — n generadú lujec, degun dat vëgn mai menà en degun post. Comuns: IGN / geo.api.gouv.fr (Etalab) per la Franzia, GeoNames (licenza CC-BY) per Andorra, Spagna, Portogal, Belgio, Paejes Bas, Lussemburg, Svizera, Germania, Italia, Austria, San Marino, Liechtenstein, Monaco, Malta, Guernsey, Jersey, la Republica Ceca, la Polonia y la Slovachia. Ponc de interess y sfont de ciarta: © i contribuënc de OpenStreetMap (licenza ODbL). Pedaje: VINCI Autoroutes (Franzia), Autopistas (Spagna), Via Verde/Ascendi (Portogal), Autostrade per l\'Italia (Italia) — autostrades debann te Belgio, Andorra, ti Paejes Bas, en Lussemburg, en Germania, en San Marino, en Liechtenstein, en Monaco, en Malta y en Polonia (fòra de trëi tòcs en concescion); vignetta anuala en Svizera, en Austria, en la Republica Ceca y en Slovachia (degun pedaje per viac) — degun pedaje ne vignetta a Guernsey y Jersey.',
    ...
    mt: {
      ...
      'footer.text': "Rotta lejn l-mhux magħruf — ġeneratur ludiku, l-ebda data ma tintbagħat imkien. Bliet: IGN / geo.api.gouv.fr (Etalab) għal Franza, GeoNames (liċenzja CC-BY) għal Andorra, Spanja, il-Portugall, il-Belġju, l-Olanda, il-Lussemburgu, l-Isvizzera, il-Ġermanja, l-Italja, l-Awstrija, San Marino, il-Liechtenstein, Monaco, Malta, Guernsey, Jersey, ir-Repubblika Ċeka, il-Polonja u s-Slovakkja. Postijiet ta' interess u sfond tal-mappa: © il-kontributuri ta' OpenStreetMap (liċenzja ODbL). Pedaġġi: VINCI Autoroutes (Franza), Autopistas (Spanja), Via Verde/Ascendi (il-Portugall), Autostrade per l'Italia (l-Italja) — awtostradi b'xejn fil-Belġju, f'Andorra, fl-Olanda, fil-Lussemburgu, fil-Ġermanja, f'San Marino, fil-Liechtenstein, f'Monaco, f'Malta u fil-Polonja (ħlief tliet sezzjonijiet ikkonċessjonati); vinjetta annwali fl-Isvizzera, fl-Awstrija, fir-Repubblika Ċeka u fis-Slovakkja (l-ebda pedaġġ għal kull vjaġġ) — l-ebda pedaġġ jew vinjetta f'Guernsey u Jersey.",
    ...
    'nrf-gg': {
      ...
      'footer.text': "Routte vers l'inconnu — générateur amusant, nou n'envaie jamais d'donnée nulle part. Villes : IGN / geo.api.gouv.fr (Etalab) pour la France, GeoNames (licence CC-BY) pour l'Andorre, l'Êspagne, l'Portugal, la Belgique, les Pays-Bas, l'Luxembourg, la Suisse, l'Allemagne, l'Italie, l'Autriche, Saint-Marin, l'Liechtenstein, Monaco, Malte, Guernesi, Jèrri, la République tchèque, la Pologne et la Slovaquie. Liuets d'intérêt et fond d'carte : © les contributeurs d'OpenStreetMap (licence ODbL). Péages : VINCI Autoroutes (France), Autopistas (Êspagne), Via Verde/Ascendi (Portugal), Autostrade per l'Italia (Italie) — autoroutes gratis en Belgique, en Andorre, aux Pays-Bas, au Luxembourg, en Allemagne, à Saint-Marin, au Liechtenstein, à Monaco, à Malte et en Pologne (sauf trais bonds concédés) ; vignette annuelle en Suisse, en Autriche, en République tchèque et en Slovaquie (pon d'péage au bond) — pon d'péage ni d'vignette à Guernesi et Jèrri.",
      'footer.legalMentions': 'Mentions légales',
      'footer.privacyPolicy': "Politique d'privachetè",
    ...
    csb: {
      ...
      'footer.text': 'Kùrs na nieznóné — zabôwny generatór, żódné dôwné nie są nigdë nikąd wësłóné. Gardë: IGN / geo.api.gouv.fr (Etalab) dlô Francji, GeoNames (licencjô CC-BY) dlô Andorë, Szpaniji, Pòrtugaliji, Belgii, Niderlandów, Lëksemburga, Szwajcariji, Miemiec, Italiji, Aùstriji, San Marina, Liechtensteinu, Monaka, Malti, Guernsey, Jersey, Czeskijè Repùbliczi, Pòlsczi ë Słowacëji. Môle interesu ë spódk mapë: © wespółrobôrze OpenStreetMap (licencjô ODbL). Ùpłatë: VINCI Autoroutes (Francjô), Autopistas (Szpanijô), Via Verde/Ascendi (Pòrtugaliô), Autostrade per l\'Italia (Italiô) — darmòwé autostradë w Belgii, w Andorze, w Niderlandach, w Lëksemburgù, w Miemcach, w San Marinie, w Liechtensteinie, w Monakù ë na Malce; roczné winiete w Szwajcariji, w Aùstriji, w Czeskji Repùblice ë w Słowacëji (bez ùpłatë za drogã) — bez ùpłatë ani winietë na Guernsey ë Jersey.',
