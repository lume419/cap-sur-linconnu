...
| `npm test` | tout sauf les générateurs, tailles par défaut | ~7 à 8 min (**278 tests en 439 à 668 s** — 276 depuis le 22/09/2026, mesurés le 21/09/2026 sur quatre passages de la même machine (l'écart d'un passage à l'autre atteint 6 %, selon la charge) ; 448 s au 19e ; le chiffre de 314 s qui figurait ici datait d'avant `search.test.js`, les bornes de données et les exports PDF ; + 2 à 5 min si le serveur doit reconstruire son index de recherche) |
