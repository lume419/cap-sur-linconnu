// Alias multilingues de la péninsule Arabique, de l'Irak et de l'Iran (build-golfe-communes.js). Même
// méthode que build-afrique-australe-aliases.js. GeoNames range les noms en translittération latine :
// les alias arabes et persans sont essentiels à la recherche.
const fs = require('fs');
...
// Langues retenues pour la RECHERCHE : arabe, persan, kurde (sorani et kurmandji), turkmène, azéri,
// araméen/syriaque, baloutche, et les langues européennes déjà gérées.
const SUPPORTED_LANGS = new Set(['fr', 'en', 'de', 'it', 'es', 'pt', 'nl', 'ru', 'tr', 'ar', 'fa', 'ckb', 'ku', 'kmr', 'az', 'tk', 'syr', 'aii', 'bal', 'glk', 'mzn', 'lrc']);
