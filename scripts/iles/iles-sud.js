...
module.exports = {
  ...
  ferries: [
    { a: 'continental', b: 'samui', routeKey: 'donsakLipaNoi', "priceCovers": "vehicle", "coversSource": "véhicule seul : grille provinciale, tarif véhicule « conducteur inclus », passager déduit", "durationEstimated": true, name: 'Don Sak ↔ Ko Samui (Lipa Noi)',
    ...
    { a: 'continental', b: 'phangan', routeKey: 'donsakThongSala', "priceCovers": "vehicle", "coversSource": "véhicule seul : grille provinciale, tarif véhicule « conducteur inclus », passager déduit", "durationEstimated": true, name: 'Don Sak ↔ Ko Pha Ngan (Thong Sala)',
    ...
    { a: 'continental', b: 'kohPhaluai', routeKey: 'donsakKohPhaluai', "priceCovers": null, "coversSource": "grille Raja Ferry Port : inclusion du conducteur non écrite", name: 'Don Sak ↔ Ko Phaluai',
      operator: 'Raja Ferry Port', durationH: 1.5, distanceKm: 22,
      priceByClass: { 1: 39.09, 2: 39.09, 5: 19.55, foot: 11.73 },
      currency: 'THB', original: { car: 1500, van: 1500, moto: 750, foot: 450 },
    ...
    { a: 'southAndaman', b: 'middleNorthAndaman', routeKey: 'middleStraitNilambur', "priceCovers": "vehicle", "coversSource": "grille DSS : véhicule et passagers facturés séparément", "durationEstimated": true, name: 'Middle Strait ↔ Nilambur (Baratang)',
