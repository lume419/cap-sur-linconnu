...
module.exports = {
  landmass: {
    ...
    BS: { default: '*', rules: [
      ...
      // Clés nommées depuis le 23/09/2026 : le Bo Hengy III n'embarque pas de véhicules, ce qui les laissait isolées
      // par construction. Avec passengerOnly, la ligne est modélisable et les deux îles rentrent dans la couverture.
      { key: 'harbourIsland', match: { near: [{ name: 'Harbour Island', lat: 25.502, lon: -76.636, km: 2.5 }] },
        note: 'Harbour Island (Dunmore Town) : île distincte, desservie par le Bo Hengy III.' },
      { key: 'spanishWells', match: { near: [{ name: 'Spanish Wells', lat: 25.547, lon: -76.764, km: 2.5 }] },
        note: 'Spanish Wells (St George\'s Cay) : île distincte, desservie par le Bo Hengy III.' },
  ...
  ferries: [
    { a: 'hispaniola', b: 'puertoRico', routeKey: 'santoDomingoSanJuan', "priceCovers": null, "coversSource": "grille Ferries del Caribe : inclusion du conducteur non précisée", "durationEstimated": true, name: 'Santo Domingo ↔ San Juan',
    ...
    { a: 'trinidad', b: 'tobago', routeKey: 'portOfSpainScarborough', "priceCovers": "vehicle", "coversSource": "grille TTIT : Car/SUV « conducteur exclu »", "durationEstimated": true, name: 'Port of Spain ↔ Scarborough',
    ...
    { a: 'saintThomasVI', b: 'saintJohnVI', routeKey: 'redHookCruzBay', "priceCovers": "vehicleAndOccupants", "coversSource": "Love City Car Ferries : passagers du véhicule gratuits", "durationEstimated": true, name: 'Red Hook ↔ Cruz Bay',
    ...
    { a: 'stKitts', b: 'nevis', routeKey: 'majorsBayCadesBay', "durationEstimated": true, name: "Major's Bay ↔ Cades Bay",
    ...
    { a: 'grenada', b: 'carriacou', routeKey: 'stGeorgesTyrrelBay', "durationEstimated": true, name: "St. George's ↔ Tyrrel Bay",
    ...
    { a: 'stVincent', b: 'bequia', routeKey: 'kingstownPortElizabeth', "priceCovers": "vehicle", "priceCoversByClass": {"5":"vehicleAndDriver"}, "coversSource": "grille Bequia Express « vehicle fare includes driver » : conducteur déduit pour voiture et minibus ; moto : tarif publié pilote compris", "durationEstimated": true, name: 'Kingstown ↔ Port Elizabeth',
      operator: 'Bequia Express', durationH: 1, distanceKm: 16,
      priceByClass: { 1: 11.09, 2: 17.43, 5: 7.92, foot: 7.92 },
      currency: 'XCD', original: { car: 60, van: 80, moto: 25, foot: 25 },
      source: 'https://bequiaexpress.com/fares/',
      date: '2026-09-16',
      note: "Grille officielle aller simple, « vehicle fare includes driver » : voiture 60, minibus 80 (classe 2), moto 25 XCD, adulte 25 XCD ; véhicule seul = tarif − 25, sauf la moto : 25 XCD pilote COMPRIS = 7,92 € (le déduire du billet adulte donnait 0 ; corrigé au 10e audit du 18/09/2026). Admiral Ferries prend aussi des véhicules (tarif sur demande). Durée : ~1 h (estimation usuelle)." },
    { a: 'stVincent', b: 'canouan', routeKey: 'kingstownCanouan', "priceCovers": "vehicle", "coversSource": "grille Bequia Express « vehicle fare includes driver » : conducteur déduit (voir note)", "durationEstimated": true, name: 'Kingstown ↔ Canouan',
    ...
    { a: 'canouan', b: 'mayreau', routeKey: 'canouanMayreau', "priceCovers": "vehicle", "coversSource": "grille Bequia Express « vehicle fare includes driver » : conducteur déduit (voir note)", "durationEstimated": true, name: 'Canouan ↔ Mayreau',
    ...
    { a: 'mayreau', b: 'unionIsland', routeKey: 'mayreauUnionIsland', "priceCovers": "vehicle", "coversSource": "grille Bequia Express « vehicle fare includes driver » : conducteur déduit (voir note)", "durationEstimated": true, name: 'Mayreau ↔ Clifton (Union Island)',
    ...
    { a: 'stVincent', b: 'unionIsland', routeKey: 'kingstownUnionIsland', "priceCovers": "vehicle", "priceCoversByClass": {"5":"vehicleAndDriver"}, "coversSource": "grille Bequia Express « vehicle fare includes driver » : conducteur déduit pour voiture et minibus ; moto : tarif publié pilote compris", "durationEstimated": true, name: 'Kingstown ↔ Clifton (Union Island)',
      operator: 'Bequia Express', durationH: 4.5, distanceKm: 65,
      priceByClass: { 1: 53.88, 2: 69.73, 5: 22.18, foot: 25.35 },
      currency: 'XCD', original: { car: 250, van: 300, moto: 70, foot: 80 },
      source: 'https://bequiaexpress.com/fares/',
      date: '2026-09-16',
      note: "Grille officielle (tarif direct, même navire via Canouan et Mayreau), conducteur inclus : voiture 250, minibus 300, moto 70 XCD ; adulte 80 XCD ; véhicule seul = tarif − 80, sauf la moto : 70 XCD pilote COMPRIS = 22,18 € (seul tarif publié ; 10e audit du 18/09/2026). Durée : estimation." },
    { a: 'cuba', b: 'islaDeLaJuventud', routeKey: 'batabanoNuevaGerona', "durationEstimated": true, name: 'Surgidero de Batabanó ↔ Nueva Gerona',
    ...
    // ------------------------------------------------- Ligne internationale FRS Express des Îles
    // « VEHICLE TRANSPORT : Available only between Guadeloupe and Martinique » (page Martinique) ;
    // « VEHICLE TRANSPORT : Not available » (pages Dominique et Sainte-Lucie). « FREIGHT TRANSPORT : Not allowed »
    // partout. Tarifs « effective from March 31, 2026 » mais jamais chiffrés hors du tunnel de réservation.
    { a: 'guadeloupe', b: 'martinique', routeKey: 'pointeAPitreFortDeFrance', "priceCovers": null,
      "coversSource": "seule paire de la ligne où l'armateur écrit « VEHICLE TRANSPORT : Available » ; aucun montant n'est publié",
      name: 'Pointe-à-Pitre ↔ Fort-de-France',
      operator: 'FRS Express des Îles', durationH: 4.75, distanceKm: 184,
      priceStatus: 'unknown', priceByClass: { 1: null, 2: null, 5: null, foot: null },
      source: 'https://www.frs-express.com/en/timetable-rates/martinique-timetables-fares', date: '2026-09-23',
      note: "« From Guadeloupe: 4h45 with stopover in Dominica », terminal de Bergevin (Pointe-à-Pitre) et Inter-Islands Terminal (Fort-de-France). Seule paire de la ligne qui embarque des véhicules. 3 à 7 allers-retours par semaine selon la saison (3 en juin, septembre et janvier pour l'entretien technique, 5 en temps normal, 7 en vacances scolaires). Tarifs « effective from March 31, 2026 » : aucun montant n'est affiché hors du tunnel de réservation. Distance mesurée entre les deux lieux publiés." },
    { a: 'dominica', b: 'guadeloupe', routeKey: 'pointeAPitreRoseau', passengerOnly: true, "priceCovers": null,
      "coversSource": "la page Dominique de l'armateur porte « VEHICLE TRANSPORT : Not available »",
      name: 'Pointe-à-Pitre ↔ Roseau (Dominique)',
      operator: 'FRS Express des Îles', durationH: 2.5, distanceKm: 106,
      priceStatus: 'unknown', priceByClass: { 1: null, 2: null, 5: null, foot: null },
      source: 'https://www.frs-express.com/en/timetable-rates/dominica-timetables-fares', date: '2026-09-23',
      note: "« From Guadeloupe: 2h30 non-stop ». Aucun montant publié hors du tunnel de réservation. Distance mesurée entre les deux lieux publiés." },
    { a: 'dominica', b: 'martinique', routeKey: 'fortDeFranceRoseau', passengerOnly: true, "priceCovers": null,
      "coversSource": "la page Dominique de l'armateur porte « VEHICLE TRANSPORT : Not available »",
      name: 'Fort-de-France ↔ Roseau (Dominique)',
      operator: 'FRS Express des Îles', durationH: 2.25, distanceKm: 81,
      priceStatus: 'unknown', priceByClass: { 1: null, 2: null, 5: null, foot: null },
      source: 'https://www.frs-express.com/en/timetable-rates/dominica-timetables-fares', date: '2026-09-23',
      note: "« From Martinique: 2h15 non-stop ». Aucun montant publié hors du tunnel de réservation. Distance mesurée entre les deux lieux publiés." },
    { a: 'martinique', b: 'saintLucia', routeKey: 'fortDeFranceCastries', passengerOnly: true, "priceCovers": null,
      "coversSource": "la page Sainte-Lucie de l'armateur porte « VEHICLE TRANSPORT : Not available »",
      name: 'Fort-de-France ↔ Castries (Sainte-Lucie)',
      operator: 'FRS Express des Îles', durationH: 1.5, distanceKm: 73,
      priceStatus: 'unknown', priceByClass: { 1: null, 2: null, 5: null, foot: null },
      source: 'https://www.frs-express.com/en/timetable-rates/saint-lucia-timetables-fares', date: '2026-09-23',
      note: "« From Martinique: 1h30 non-stop ». Sainte-Lucie depuis la Guadeloupe demande 6 h 45 avec escales en Dominique et en Martinique : seule la traversée directe est modélisée, les escales se retrouvant dans l'enchaînement des étapes. Aucun montant publié hors du tunnel de réservation. Distance mesurée entre les deux lieux publiés." },
    // ------------------------------------------------- Bahamas : Bo Hengy III (Bahamas Ferries)
    // Grille passagers publiée, TVA comprise ; vélos et chiens tarifés, AUCUNE ligne véhicule.
    { a: 'newProvidence', b: 'spanishWells', routeKey: 'nassauSpanishWells', passengerOnly: true, "priceCovers": null,
      "coversSource": "grille passagers du Bo Hengy III : vélos (18 et 34 \$) et chiens tarifés, aucune ligne véhicule",
      name: 'Nassau ↔ Spanish Wells',
      operator: 'Bahamas Ferries (M/V Bo Hengy III)', durationH: 2.17, distanceKm: 80,
      ...
      note: "Horaire publié : départ Nassau 8 h 00, arrivée Spanish Wells 10 h 10 (2 h 10), les mercredis, vendredis et samedis. « Adult One Way \$139.00 », « All rates are inclusive of Value Added Tax (VAT) ». Dollar bahaméen au pair avec le dollar américain ; converti au taux InforEuro de septembre 2026 (1 EUR = 1,1643 USD). Distance mesurée entre les deux lieux publiés." },
    { a: 'harbourIsland', b: 'spanishWells', routeKey: 'spanishWellsHarbourIsland', passengerOnly: true, "priceCovers": null,
      "coversSource": "grille passagers du Bo Hengy III : vélos et chiens tarifés, aucune ligne véhicule",
      name: 'Spanish Wells ↔ Harbour Island',
      operator: 'Bahamas Ferries (M/V Bo Hengy III)', durationH: 0.75, distanceKm: 14,
      priceByClass: { 1: null, 2: null, 5: null, foot: 40.37 },
      currency: 'BSD', original: { foot: 47 },
      source: 'https://bahamasferries.com/your-travel/', date: '2026-09-23',
      note: "Horaire publié : Spanish Wells 10 h 25 → Harbour Island 11 h 10 (45 min). Tarif inter-îles « Adult One Way \$47.00 », TVA comprise. Distance mesurée entre les deux lieux publiés." },
    { a: 'harbourIsland', b: 'newProvidence', routeKey: 'nassauHarbourIsland', passengerOnly: true, "priceCovers": null,
      "coversSource": "grille passagers du Bo Hengy III : vélos et chiens tarifés, aucune ligne véhicule",
      name: 'Nassau ↔ Harbour Island',
      operator: 'Bahamas Ferries (M/V Bo Hengy III)', durationH: 3.17, distanceKm: 87,
      priceByClass: { 1: null, 2: null, 5: null, foot: 119.39 },
      currency: 'BSD', original: { foot: 139 },
      source: 'https://bahamasferries.com/your-travel/', date: '2026-09-23',
