...
module.exports = {
  ...
  ferries: [
    // ------------------------------------------------------------------ GB : CalMac
    { a: 'arran', b: 'greatBritain', routeKey: 'ardrossanBrodick', name: 'Ardrossan ↔ Brodick', operator: 'CalMac',
    ...
    { a: 'bute', b: 'greatBritain', routeKey: 'wemyssBayRothesay', name: 'Wemyss Bay ↔ Rothesay', operator: 'CalMac',
    ...
    { a: 'cumbrae', b: 'greatBritain', routeKey: 'largsCumbrae', name: 'Largs ↔ Cumbrae Slip', operator: 'CalMac',
    ...
    { a: 'greatBritain', b: 'mull', routeKey: 'obanCraignure', name: 'Oban ↔ Craignure', operator: 'CalMac',
    ...
    { a: 'greatBritain', b: 'islay', routeKey: 'kennacraigIslay', name: 'Kennacraig ↔ Port Askaig / Port Ellen', operator: 'CalMac',
    ...
    { a: 'islay', b: 'jura', routeKey: 'portAskaigFeolin', name: 'Port Askaig ↔ Feolin', operator: 'Argyll and Bute Council',
    ...
    { a: 'colonsay', b: 'greatBritain', routeKey: 'obanColonsay', name: 'Oban ↔ Colonsay', operator: 'CalMac',
    ...
    { a: 'colonsay', b: 'islay', routeKey: 'portAskaigColonsay', name: 'Port Askaig ↔ Colonsay', operator: 'CalMac',
    ...
    { a: 'gigha', b: 'greatBritain', routeKey: 'tayinloanGigha', name: 'Tayinloan ↔ Gigha', operator: 'CalMac',
    ...
    { a: 'coll', b: 'greatBritain', routeKey: 'obanColl', name: 'Oban ↔ Coll', operator: 'CalMac',
    ...
    { a: 'greatBritain', b: 'tiree', routeKey: 'obanTiree', name: 'Oban ↔ Tiree', operator: 'CalMac',
    ...
    { a: 'coll', b: 'tiree', routeKey: 'collTiree', name: 'Coll ↔ Tiree', operator: 'CalMac',
    ...
    { a: 'greatBritain', b: 'lismore', routeKey: 'obanLismore', name: 'Oban ↔ Lismore', operator: 'CalMac',
    ...
    { a: 'greatBritain', b: 'luing', routeKey: 'cuanLuing', name: 'Cuan ↔ Luing', operator: 'Argyll and Bute Council',
    ...
    { a: 'greatBritain', b: 'raasay', routeKey: 'sconserRaasay', name: 'Sconser ↔ Raasay', operator: 'CalMac',
    ...
    { a: 'greatBritain', b: 'lewisHarris', routeKey: 'ullapoolStornoway', name: 'Ullapool ↔ Stornoway', operator: 'CalMac',
    ...
    { a: 'greatBritain', b: 'uist', routeKey: 'uigLochmaddy', name: 'Uig ↔ Lochmaddy', operator: 'CalMac',
    ...
    { a: 'lewisHarris', b: 'uist', routeKey: 'bernerayLeverburgh', name: 'Berneray ↔ Leverburgh', operator: 'CalMac',
    ...
    { a: 'barra', b: 'uist', routeKey: 'ardmhorEriskay', name: 'Ardmhor (Barra) ↔ Eriskay', operator: 'CalMac',
    ...
    { a: 'barra', b: 'greatBritain', routeKey: 'obanCastlebay', name: 'Oban ↔ Castlebay', operator: 'CalMac',
    ...
    { a: 'hoy', b: 'orkney', routeKey: 'houtonLyness', name: 'Houton ↔ Lyness', operator: 'Orkney Ferries',
    ...
    { a: 'orkney', b: 'rousay', routeKey: 'tingwallRousay', name: 'Tingwall ↔ Rousay', operator: 'Orkney Ferries',
      durationH: 0.42, distanceKm: 5, priceByClass: orkS,
      source: 'https://www.orkneyferries.co.uk/documents/south-and-inner-isles-2026-27', date: D,
      note: 'Même grille que Hoy. Tingwall 11:50 → Rousay 12:15 (été 2026).' },
    { a: 'orkney', b: 'shapinsay', routeKey: 'kirkwallShapinsay', name: 'Kirkwall ↔ Shapinsay', operator: 'Orkney Ferries',
    ...
    { a: 'orkney', b: 'westray', routeKey: 'kirkwallWestray', name: 'Kirkwall ↔ Rapness (Westray)', operator: 'Orkney Ferries',
    ...
    { a: 'eday', b: 'orkney', routeKey: 'kirkwallEday', name: 'Kirkwall ↔ Eday', operator: 'Orkney Ferries',
      durationH: 1.25, distanceKm: 25, priceByClass: orkN,
      source: 'https://www.orkneyferries.co.uk/documents/north-isles-fares-26-27', date: D,
      note: 'Grille North Isles. Kirkwall 16:00 → Eday 17:15 (été 2026).' },
    { a: 'orkney', b: 'sanday', routeKey: 'kirkwallSanday', name: 'Kirkwall ↔ Loth (Sanday)', operator: 'Orkney Ferries',
      durationH: 1.75, distanceKm: 28, priceByClass: orkN,
      source: 'https://www.orkneyferries.co.uk/documents/north-isles-fares-26-27', date: D,
      note: 'Grille North Isles. Kirkwall 07:40 → Sanday 09:25 via Stronsay (été 2026).' },
    { a: 'orkney', b: 'stronsay', routeKey: 'kirkwallStronsay', name: 'Kirkwall ↔ Whitehall (Stronsay)', operator: 'Orkney Ferries',
    ...
    { a: 'bressay', b: 'shetland', routeKey: 'lerwickBressay', name: 'Lerwick ↔ Bressay', operator: 'Shetland Islands Council',
    ...
    { a: 'shetland', b: 'yell', routeKey: 'toftUlsta', name: 'Toft ↔ Ulsta', operator: 'Shetland Islands Council',
      durationH: 0.33, distanceKm: 4, priceByClass: shet, source: SHET_SRC, date: D,
      note: 'Même grille que Bressay. 20 min (shetland.org).' },
    { a: 'unst', b: 'yell', routeKey: 'gutcherBelmont', name: 'Gutcher ↔ Belmont', operator: 'Shetland Islands Council',
    ...
    { a: 'fetlar', b: 'yell', routeKey: 'gutcherHamarsNess', name: 'Gutcher ↔ Hamars Ness (Fetlar)', operator: 'Shetland Islands Council',
      durationH: 0.42, distanceKm: 7, priceByClass: shet, source: SHET_SRC, date: D,
      note: 'Même grille. 25 min (shetland.org).' },
    { a: 'papaStour', b: 'shetland', routeKey: 'westBurrafirthPapaStour', name: 'West Burrafirth ↔ Papa Stour', operator: 'Shetland Islands Council',
    ...
    // ------------------------------------------------------------------ IS
    { a: 'iceland', b: 'vestmannaeyjar', routeKey: 'landeyjahofnVestmannaeyjar', name: 'Landeyjahöfn ↔ Vestmannaeyjar', operator: 'Herjólfur ohf.',
    ...
    { a: 'grimsey', b: 'iceland', routeKey: 'dalvikGrimsey', name: 'Dalvík ↔ Grímsey', operator: 'Vegagerðin (Sæfari)',
    ...
    { a: 'faroe', b: 'kalsoy', routeKey: 'klaksvikKalsoy', name: 'Klaksvík ↔ Syðradalur (Kalsoy)', operator: 'Strandfaraskip Landsins',
    ...
    { a: 'faroe', b: 'nolsoy', routeKey: 'torshavnNolsoy', name: 'Tórshavn ↔ Nólsoy', operator: 'Strandfaraskip Landsins',
