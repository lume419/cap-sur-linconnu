...
module.exports = {
  ...
  ferries: [
    { a: 'saintPierre', b: 'miquelon', routeKey: 'saintPierreMiquelon', name: 'Saint-Pierre ↔ Miquelon',
    ...
    { a: 'tahiti', b: 'moorea', routeKey: 'papeeteVaiare', name: 'Papeete ↔ Vaiare (Moorea)',
    ...
    { a: 'continental', b: 'yeu', routeKey: 'fromentineYeu', name: "Fromentine ↔ Port-Joinville (Île d'Yeu)",
