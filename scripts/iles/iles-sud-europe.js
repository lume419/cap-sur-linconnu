...
module.exports = {
  ...
  ferries: [
    ...
    { a: 'canary', b: 'lanzarote', routeKey: 'lasPalmasArrecife', "durationEstimated": true, name: 'Las Palmas ↔ Arrecife',
    ...
    { a: 'continental', b: 'lanzarote', routeKey: 'cadizArrecife', "durationEstimated": true, name: 'Cadix ↔ Arrecife',
    ...
    { a: 'ibiza', b: 'formentera', routeKey: 'ibizaLaSavina', "durationEstimated": true, name: 'Ibiza ↔ La Savina (Formentera)',
      operator: 'Baleària, Trasmapi', durationH: 1, distanceKm: 20,
      priceStatus: 'variable', priceByClass: N,
      ...
      note: "Véhicules acceptés, MAIS du 1er juin au 30 septembre autorisation préalable obligatoire sur formentera.eco (quota 1 732 voitures et 122 motos/jour pour les visitants ; taxe non-résidents 6 €/jour voiture, minimum 30 €, 3 €/jour moto, minimum 15 €). Durée : ordre de grandeur (rapide ~30 min, conventionnel ~1 h). 13e audit du 19/09/2026 : 0,5 h (40 km/h, navire rapide) remplacé par la durée du conventionnel citée ci-dessus, 1 h (20 km/h, proche de la médiane de 19,0 km/h des 51 liaisons à durée publiée de 15 à 45 km) : la source ne dit pas quels navires prennent les véhicules. Estimation, toujours marquée durationEstimated." },
    ...
    // ===================================================================== MADÈRE / AÇORES
    { a: 'madeira', b: 'portoSanto', routeKey: 'funchalPortoSanto', "priceCovers": "vehicle", "coversSource": "grille Porto Santo Line : conducteur non inclus (billet passager séparé)", "durationEstimated": true, name: 'Funchal ↔ Porto Santo',
    ...
    { a: 'faial', b: 'pico', routeKey: 'hortaMadalena', "durationEstimated": true, name: 'Horta ↔ Madalena',
    ...
    { a: 'saoJorge', b: 'terceira', routeKey: 'velasPraiaVitoria', "durationEstimated": true, name: 'Velas ↔ Praia da Vitória',
    ...
    { a: 'graciosaAzores', b: 'terceira', routeKey: 'graciosaPraiaVitoria', "durationEstimated": true, name: 'Graciosa ↔ Praia da Vitória',
    ...
    // ===================================================================== ITALIE
    { a: 'continental', b: 'elba', routeKey: 'piombinoPortoferraio', "durationEstimated": true, name: 'Piombino ↔ Portoferraio',
    ...
    { a: 'continental', b: 'capraia', routeKey: 'livornoCapraia', "durationEstimated": true, name: 'Livourne ↔ Capraia',
    ...
    { a: 'continental', b: 'giglio', routeKey: 'portoSantoStefanoGiglio', "durationEstimated": true, name: 'Porto Santo Stefano ↔ Giglio Porto',
    ...
    { a: 'continental', b: 'ischia', routeKey: 'pozzuoliIschia', "priceCovers": null, "coversSource": "grille : inclusion du conducteur non précisée", "durationEstimated": true, name: 'Pozzuoli ↔ Ischia',
    ...
    { a: 'continental', b: 'ponza', routeKey: 'formiaPonza', "priceCovers": null, "coversSource": "grille : inclusion du conducteur non précisée", "durationEstimated": true, name: 'Formia ↔ Ponza',
    ...
    { a: 'sicily', b: 'vulcano', routeKey: 'milazzoVulcano', "priceCovers": null, "coversSource": "grille : inclusion du conducteur non précisée", "durationEstimated": true, name: 'Milazzo ↔ Vulcano',
    ...
    { a: 'sicily', b: 'lipari', routeKey: 'milazzoLipari', "priceCovers": null, "coversSource": "grille : inclusion du conducteur non précisée", "durationEstimated": true, name: 'Milazzo ↔ Lipari',
    ...
    { a: 'lipari', b: 'vulcano', routeKey: 'lipariVulcano', "priceCovers": null, "coversSource": "grille : inclusion du conducteur non précisée", "durationEstimated": true, name: 'Lipari ↔ Vulcano',
    ...
    { a: 'lipari', b: 'salina', routeKey: 'lipariSantaMarinaSalina', "priceCovers": null, "coversSource": "grille : inclusion du conducteur non précisée", "durationEstimated": true, name: 'Lipari ↔ Santa Marina Salina',
    ...
    { a: 'salina', b: 'filicudi', routeKey: 'rinellaFilicudi', "priceCovers": null, "coversSource": "grille : inclusion du conducteur non précisée", "durationEstimated": true, name: 'Rinella (Salina) ↔ Filicudi',
    ...
    { a: 'sicily', b: 'favignana', routeKey: 'trapaniFavignana', "priceCovers": null, "coversSource": "grille : inclusion du conducteur non précisée", "durationEstimated": true, name: 'Trapani ↔ Favignana',
      operator: 'Siremar – Caronte & Tourist Isole Minori', durationH: 0.75, distanceKm: 18,
      priceByClass: { 1: 57.23, 2: null, 5: 26.91, foot: 10.54 },
      source: 'https://cdn.carontetourist.it/sites/default/files/2026-09/listino-prezzi-siremar-ordinaria-valida-dal-10-09-2026_1.pdf', date: D,
      note: "Même liste (page Égades) : AUTO 57,23 €, MOTO 26,91 €, place pont basse saison 10,54 € (haute 11,38), CAMPER/RIMORCHIO ≤ 5 m 45,81 € (≤ 4,5 m 30,76). 11e audit (19/09/2026) : classe 2 remise à null — le tarif CAMPER/RIMORCHIO (≤ 5 m 45,81 €) est inférieur au tarif AUTO (57,23 €), ce qui désigne vraisemblablement un supplément de remorque/caravane et non le prix d'un camping-car seul (même lecture que pour les Éoliennes) ; la grille PDF (chiffres vectorisés) n'a pas pu être relue pour trancher. Débarquement des non-résidents limité l'été (en général juillet-fin de saison), fixé chaque année. Durée : ordre de grandeur." },
    { a: 'sicily', b: 'levanzo', routeKey: 'trapaniLevanzo', "priceCovers": null, "coversSource": "grille : inclusion du conducteur non précisée", "durationEstimated": true, name: 'Trapani ↔ Levanzo',
      operator: 'Siremar – Caronte & Tourist Isole Minori', durationH: 0.75, distanceKm: 15,
      priceByClass: { 1: 57.23, 2: null, 5: 26.91, foot: 10.54 },
      source: 'https://cdn.carontetourist.it/sites/default/files/2026-09/listino-prezzi-siremar-ordinaria-valida-dal-10-09-2026_1.pdf', date: D,
      note: "Même liste : Trapani-Levanzo mêmes montants que Trapani-Favignana (AUTO 57,23 €, MOTO 26,91 €, camper ≤ 5 m 45,81 €, place pont 10,54 €). 11e audit (19/09/2026) : classe 2 remise à null — le tarif CAMPER/RIMORCHIO (≤ 5 m 45,81 €) est inférieur au tarif AUTO (57,23 €), ce qui désigne vraisemblablement un supplément de remorque/caravane et non le prix d'un camping-car seul (même lecture que pour les Éoliennes) ; la grille PDF (chiffres vectorisés) n'a pas pu être relue pour trancher. Île minuscule au réseau routier quasi inexistant. Durée : ordre de grandeur." },
    { a: 'sardinia', b: 'laMaddalena', routeKey: 'palauLaMaddalena', "priceCovers": null, "coversSource": "grille : inclusion du conducteur non précisée", "durationEstimated": true, name: 'Palau ↔ La Maddalena',
    ...
    { a: 'sardinia', b: 'sanPietro', routeKey: 'portovesmeCarloforte', "priceCovers": null, "coversSource": "grille : inclusion du conducteur non précisée", "durationEstimated": true, name: 'Portovesme ↔ Carloforte',
    ...
    { a: 'continental', b: 'lidoVenezia', routeKey: 'tronchettoLido', "priceCovers": "vehicle", "coversSource": "véhicule seul : ACTV, « vehicle tickets do not include the driver »", "durationEstimated": true, name: 'Tronchetto ↔ Lido (ferry-boat ligne 17)',
    ...
    { a: 'lidoVenezia', b: 'pellestrina', routeKey: 'alberoniSantaMariaDelMare', "priceCovers": "vehicle", "coversSource": "véhicule seul : ACTV, « vehicle tickets do not include the driver »", "durationEstimated": true, name: 'Alberoni ↔ Santa Maria del Mare (ferry-boat ligne 11)',
