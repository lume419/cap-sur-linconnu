...
module.exports = {
  ...
  ferries: [
    { a: 'java', b: 'sumatra', routeKey: 'merakBakauheni', "priceCovers": "vehicleAndOccupants", "coversSource": "billet véhicule indonésien : « pembelian tiket kendaraan sudah termasuk kendaraan berserta penumpang / muatan di atas kendaraan » (Satpel Lembar, BPTD NTB – Kemenhub, https://www.satpellembar.info/tarif/)", "durationEstimated": true, name: 'Merak ↔ Bakauheni',
      ...
      source: 'https://www.asdp.id/siaran-pers/tarif-baru-penyeberangan-pada-29-lintasan-di-seluruh-indonesia-resmi-berlaku (communiqué ASDP, tarifs en vigueur au 3/08/2023) ; KM 61 Tahun 2023, https://jdih.dephub.go.id (statut « Berlaku »)',
      date: '2026-09-16',
      note: "11e audit (19/09/2026) : prix tirés du seul communiqué de l'exploitant ASDP (adulte 22 700, golongan II 62 100, IVA 481 800, VA 963 800 IDR ; la presse n'est plus citée) ; le KM 61/2023 fixe le tarif de base hors redevance portuaire et assurance Jasa Raharja (17 300 / 45 600 / 427 200 / 856 200). Service régulier (hors « express »). Base : KM 61 Tahun 2023 (en vigueur depuis le 3/08/2023) ; la hausse de ~5 % du KM 131 Tahun 2024 (23 400 / 512 600 IDR…) a été reportée puis annulée par la DG Hubdat. Moto : 62 100 IDR selon le tableau detik (12/2024) et le communiqué ASDP ; une autre version du communiqué indique 60 600. Remises ponctuelles (Lebaran, Nataru) ignorées. Billet véhicule = occupants inclus." },
    { a: 'java', b: 'bali', routeKey: 'ketapangGilimanuk', "durationEstimated": true, name: 'Ketapang ↔ Gilimanuk',
      ...
      date: '2026-02-09',
      note: "Prix non retenus (11e audit, 19/09/2026) : aucune grille officielle du prix du billet : le KM 61/2023 (lampiran n° 2) ne donne que le tarif de base hors redevance portuaire et Jasa Raharja (6 000 / 18 500 / 169 400 / 333 500 IDR), et les prix au guichet ne sont publiés que par la presse (detik). Relevé : Tarifs KM 61 Tahun 2023 (hausse du 3/08/2023). Dewasa, golongan II et IVA : detikJatim 9/02/2026. Golongan VA (420 400 IDR) : relevé dans la même série de publications de presse, non repris dans l'article detik — chiffre le moins solide. Traversée 45–60 min. Billet véhicule = occupants inclus." },
    { a: 'bali', b: 'lombok', routeKey: 'padangbaiLembar', "priceCovers": "vehicleAndOccupants", "coversSource": "billet véhicule indonésien : « pembelian tiket kendaraan sudah termasuk kendaraan berserta penumpang / muatan di atas kendaraan » (Satpel Lembar, BPTD NTB – Kemenhub, https://www.satpellembar.info/tarif/)", "durationEstimated": true, name: 'Padangbai ↔ Lembar',
    ...
    { a: 'lombok', b: 'sumbawa', routeKey: 'kayanganPototano', "durationEstimated": true, name: 'Kayangan ↔ Poto Tano',
      ...
      date: '2026-03-17',
      note: "Prix non retenus (11e audit, 19/09/2026) : l'arrêté du gouverneur de NTB n° 550-08/2023 figure au registre du JDIH provincial mais sa grille n'est pas publiée en ligne ; montants connus par la seule presse. Relevé : Liaison intra-provinciale : tarif fixé par arrêté du gouverneur de NTB (signé le 3/01/2023, en vigueur le 12/01/2023, +10,41 %). Voiture ≤ 5 m 563 000, bus moyen ≤ 7 m 893 000, moto < 500 cc 75 000, passager 18 800 IDR ; tarifs normaux confirmés inchangés en mars 2026 (18 800 adulte, 32 000 vélo, 2 265 000 golongan IX). Remise Lebaran 2026 ignorée." },
    { a: 'sumbawa', b: 'flores', routeKey: 'sapeLabuanBajo', "durationEstimated": true, name: 'Sape ↔ Labuan Bajo',
      ...
      date: '2025-12',
      note: "Prix non retenus (11e audit, 19/09/2026) : aucune grille officielle du prix du billet : le KM 61/2023 (lampiran n° 11) ne donne que le tarif de base (87 500 / 203 300 / 1 686 700 / 3 221 400 IDR), le prix au guichet n'est cité que par la presse (detik). Relevé : Tarifs normaux (avant remise Nataru 2025/26) cités par le chef de port : adulte 95 600, moto 250 400, petit véhicule 1 779 000, bus moyen 3 417 700 IDR. Une traversée par jour dans chaque sens. Durée et distance : estimations (orthodromie ~96 km, 6–8 h)." },
    { a: 'sumatra', b: 'bangka', routeKey: 'tanjungApiApiTanjungKalian', "durationEstimated": true, name: 'Tanjung Api-Api ↔ Tanjung Kalian (Muntok)',
      ...
      date: '2026-07-23',
      note: "Prix non retenus (11e audit, 19/09/2026) : aucune grille officielle du prix du billet : le KM 61/2023 (lampiran n° 5) ne donne que le tarif de base (47 800 / 115 900 / 970 600 / 1 686 900 IDR), le prix au guichet n'est cité que par la presse (IDN Times). Relevé : Grille relevée par IDN Times Sumsel (juillet 2026) : dewasa 58 100, golongan II 138 000, IVA 1 051 200, VA 1 864 200 IDR. Une autre publication (2025) donne IVA 998 500 et II 130 550 : écart signalé. Traversée 3–4 h. Billet véhicule = occupants inclus." },
    { a: 'continental', b: 'langkawi', routeKey: 'kualaPerlisLangkawi', "priceCovers": null, "coversSource": "grille Langkawi RoRo : inclusion du conducteur non précisée", "durationEstimated": true, name: 'Kuala Perlis ↔ Langkawi (RoRo)',
