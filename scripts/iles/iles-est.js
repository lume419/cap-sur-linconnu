module.exports = {
  ...
  ferries: [
    { a: 'honshu', b: 'hokkaido', routeKey: 'aomoriHakodate', "priceCovers": "vehicle", "priceCoversByClass": {"2":null}, "coversSource": "véhicule seul : grille Tsugaru Kaikyō « conducteur inclus » pour les < 6 m (Standard déduit) ; classe 2 (6-7 m) : inclusion du conducteur non écrite sur la grille ; moto passager en sus", "durationEstimated": true, name: 'Aomori ↔ Hakodate',
    ...
    { a: 'honshu', b: 'okinawa', routeKey: 'kagoshimaNaha', "priceCovers": "vehicle", "coversSource": "véhicule seul : grille A-Line, tarif véhicule incluant la 2e classe du conducteur (déduite) ; moto passager en sus", "durationEstimated": true, name: 'Kagoshima ↔ Naha',
    ...
    { a: 'honshu', b: 'amami', routeKey: 'kagoshimaNaze', "priceCovers": "vehicle", "coversSource": "véhicule seul : grille A-Line, tarif véhicule incluant la 2e classe du conducteur (déduite) ; moto passager en sus", "durationEstimated": true, name: 'Kagoshima ↔ Naze (Amami-Ōshima)',
    ...
    { a: 'honshu', b: 'tokunoshima', routeKey: 'kagoshimaKametoku', "priceCovers": "vehicle", "coversSource": "véhicule seul : grille A-Line, tarif véhicule incluant la 2e classe du conducteur (déduite) ; moto passager en sus", "durationEstimated": true, name: 'Kagoshima ↔ Kametoku (Tokunoshima)',
    ...
    { a: 'honshu', b: 'okinoerabu', routeKey: 'kagoshimaWadomari', "priceCovers": "vehicle", "coversSource": "véhicule seul : grille A-Line, tarif véhicule incluant la 2e classe du conducteur (déduite) ; moto passager en sus", "durationEstimated": true, name: 'Kagoshima ↔ Wadomari (Okinoerabu)',
    ...
    { a: 'continental', b: 'honshu', routeKey: 'busanShimonoseki', "priceCovers": "vehicle", "coversSource": "véhicule seul : grille Kampu, tarif « conducteur inclus » en 2e classe (déduit)", name: 'Busan ↔ Shimonoseki',
    ...
    { a: 'taiwan', b: 'penghu', routeKey: 'kaohsiungMagong', "priceCovers": "vehicle", "coversSource": "véhicule seul : fret véhicule sans billet du conducteur (grilles de l'exploitant)", "durationEstimated": true, name: 'Kaohsiung ↔ Magong',
    ...
    { a: 'taiwan', b: 'nangan', routeKey: 'keelungFuao', "priceCovers": "vehicle", "coversSource": "véhicule seul : fret véhicule sans billet du conducteur (grilles de l'exploitant)", "durationEstimated": true, name: 'Keelung ↔ Fu’ao (Nangan)',
    ...
    { a: 'taiwan', b: 'dongyin', routeKey: 'keelungZhongzhu', "priceCovers": "vehicle", "coversSource": "véhicule seul : fret véhicule sans billet du conducteur (grilles de l'exploitant)", "durationEstimated": true, name: 'Keelung ↔ Zhongzhu (Dongyin)',
    ...
    { a: 'nangan', b: 'dongyin', routeKey: 'fuaoZhongzhu', "priceCovers": "vehicle", "coversSource": "véhicule seul : fret véhicule sans billet du conducteur (grilles de l'exploitant)", "durationEstimated": true, name: 'Fu’ao (Nangan) ↔ Zhongzhu (Dongyin)',
