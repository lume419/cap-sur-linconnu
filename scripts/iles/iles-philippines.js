...
module.exports = {
  ...
  ferries: [
    { a: 'luzon', b: 'mindoro', routeKey: 'batangasCalapan', "priceCovers": null, "coversSource": "grille « rolling cargo » : inclusion du conducteur non précisée", "durationEstimated": true, name: 'Batangas ↔ Calapan',
    ...
    { a: 'mindoro', b: 'panay', routeKey: 'roxasCaticlan', "priceCovers": null, "coversSource": "grille « rolling cargo » : inclusion du conducteur non précisée", name: 'Roxas (Mindoro) ↔ Caticlan',
    ...
    { a: 'luzon', b: 'panay', routeKey: 'batangasCaticlan', "priceCovers": null, "coversSource": "grille « rolling cargo » : inclusion du conducteur non précisée", "durationEstimated": true, name: 'Batangas ↔ Caticlan',
    ...
    { a: 'luzon', b: 'romblon', routeKey: 'batangasRomblon', "priceCovers": null, "coversSource": "grille « rolling cargo » : inclusion du conducteur non précisée", name: 'Batangas ↔ Romblon',
    ...
    { a: 'romblon', b: 'sibuyan', routeKey: 'romblonMagdiwang', "priceCovers": null, "coversSource": "grille « rolling cargo » : inclusion du conducteur non précisée", "durationEstimated": true, name: 'Romblon ↔ Magdiwang (Sibuyan)',
    ...
    { a: 'romblon', b: 'panay', routeKey: 'romblonRoxasCity', "priceCovers": null, "coversSource": "grille « rolling cargo » : inclusion du conducteur non précisée", "durationEstimated": true, name: 'Romblon ↔ Roxas City',
    ...
    { a: 'luzon', b: 'sibuyan', routeKey: 'batangasMagdiwang', "priceCovers": null, "coversSource": "grille « rolling cargo » : inclusion du conducteur non précisée", "durationEstimated": true, name: 'Batangas ↔ Magdiwang (Sibuyan)',
    ...
    { a: 'cebu', b: 'bohol', routeKey: 'cebuTagbilaran', "priceCovers": null, "coversSource": "grille « rolling cargo » : inclusion du conducteur non précisée", "durationEstimated": true, name: 'Cebu ↔ Tagbilaran',
    ...
    { a: 'cebu', b: 'masbate', routeKey: 'cebuMasbate', "priceCovers": null, "coversSource": "grille « rolling cargo » : inclusion du conducteur non précisée", "durationEstimated": true, name: 'Cebu ↔ Masbate',
    ...
    { a: 'cebu', b: 'panay', routeKey: 'cebuIloilo', "priceCovers": null, "coversSource": "grille « rolling cargo » : inclusion du conducteur non précisée", "durationEstimated": true, name: 'Cebu ↔ Iloilo',
    ...
    { a: 'cebu', b: 'mindanao', routeKey: 'cebuCagayanDeOro', "priceCovers": null, "coversSource": "grille « rolling cargo » : inclusion du conducteur non précisée", "durationEstimated": true, name: 'Cebu ↔ Cagayan de Oro',
    ...
    { a: 'bohol', b: 'mindanao', routeKey: 'tagbilaranCagayanDeOro', "priceCovers": null, "coversSource": "grille « rolling cargo » : inclusion du conducteur non précisée", "durationEstimated": true, name: 'Tagbilaran ↔ Cagayan de Oro',
    ...
    { a: 'mindanao', b: 'camiguin', routeKey: 'balingoanBenoni', "priceCovers": null, "coversSource": "grille « rolling cargo » : inclusion du conducteur non précisée", "durationEstimated": true, name: 'Balingoan ↔ Benoni (Camiguin)',
